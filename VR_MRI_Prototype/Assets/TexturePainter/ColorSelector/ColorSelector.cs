...
public class ColorSelector : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject colorSelection, marker;
    ...
    {
        colorSelection.GetComponent<Renderer>().material.color = finalColor;
        marker.GetComponent<Renderer>().materials[2].color = finalColor;
    }

    public void UserInputUpdate(Vector2 localPosition)
    {
